 ...
 * shortest possible real duration of one period. Kept conservatively low so the
 * contract never rejects a legitimate charge — the backend's exact dates always
 * advance the schedule by at least this much per period.
 */
